...
* [flet](https://flet.dev/) basado en [Flutter](https://flutter.dev/) se puede programar con Python y otros lenguajes. Tiene un aspecto moderno y las aplicaciones se pueden utilizar en multitud de plataformas también en iOS y Android. Es muy reciente y está en continuo desarrollo.
