...
while running:  # bucle de eventos
    ...
    if teclas_pulsadas[pygame.K_UP] and y_cuadrado > 0:
        y_cuadrado -= 10
    if teclas_pulsadas[pygame.K_DOWN] and y_cuadrado < alto - alto_cuadrado:
        y_cuadrado += 10               
    if teclas_pulsadas[pygame.K_LEFT] and x_cuadrado > 0:
        x_cuadrado -= 10
    if teclas_pulsadas[pygame.K_RIGHT] and x_cuadrado < ancho - ancho_cuadrado:
        x_cuadrado += 10
    ...
    if  x_cuadrado < x_ball < x_cuadrado+ancho_cuadrado and y_cuadrado < y_ball < y_cuadrado+ alto_cuadrado:
        print(f'Hay colision!!  {colisiones}')
        colisiones += 1
